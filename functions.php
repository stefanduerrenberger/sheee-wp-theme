<?php
/**
 * sheee2 functions and definitions
 *
...
if ( ! function_exists( 'sheee2_setup' ) ) {
	/**
	 ...
	 */
	function sheee2_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on sheee2, use a find and replace
		 * to change 'sheee2' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'sheee2', get_template_directory() . '/languages' );
...
add_action( 'after_setup_theme', 'sheee2_setup' );
...
function sheee2_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Footer', 'sheee2' ),
		'id'            => 'footer_1',
		'description'   => esc_html__( 'Add widgets here.', 'sheee2' ),
